...
words =[
    'ant', 'acid', 'apple', 'asia', 
    'bear', 'ball', 'banana', 'berlin', 
    'crab', 'cake', 'cherry', 'china', 
    'deer', 'doll', 'date', 'dallas',
    'eagle', 'egg', 'ease', 'egypt'
]
...
def open_url():
    ...
    url = "https://02dd5f64038d9e2d7aae-56d86e996af26366aec8b255ed6f7c7b.ssl.cf3.rackcdn.com/img-SPF3ptfd-large.jpg"
    webbrowser.open(url)
